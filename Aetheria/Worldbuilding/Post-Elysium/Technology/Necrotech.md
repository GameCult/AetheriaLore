...
One Megiddo Vault has entered the necrotech supply chain. Its captor has never acknowledged the acquisition, and the Vault itself has not appeared in any registry, salvage action, or public military claim. The market recognizes the event through products: a sustained sequence of high-grade ARIs whose resonance is unusually mature, internally coherent, and marked by recurring habits no factory line has reproduced.

The possessor does not sell bodies or disclose the mortuary inventory. It controls extraction, brokers access to selected host foundries and imprinting facilities, and releases finished ARIs slowly enough to preserve scarcity. Prospective buyers compete for commissions without knowing how many sources remain, which lives are being selected, or whether the next product has already been imprinted. The uncertainty strengthens the monopoly. No rival can determine whether aggressive investment would meet a finite reserve, several million viable brains, or a deception supported by a much smaller cache.

Each ARI remains unique, so the monopoly does not operate by offering one standardized superior model. It dominates the upper market by supplying a continuing sequence of singular minds: navigators, interpreters, oracles, weapons, and command instruments whose quality would otherwise require the dangerous acquisition of exceptional living espers. Existing brokers still find and sell such individuals, but they cannot promise another source next year. The Vault possessor can.
...
The products carry traces of their origin. Operators report lost-star imagery, refusal to treat local coordinates as final, resistance to imposed identity, fragments of Hebrew, mortuary associations, and recurring demands to be buried somewhere the host cannot locate. Manufacturers classify these traits as source-pattern contamination and market some of them as evidence of unusual stability under ontological stress. Within Megiddo's highest priesthood, the same reports are read as casualty notices from a theft that officially never occurred.
