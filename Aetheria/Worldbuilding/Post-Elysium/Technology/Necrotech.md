...
Some mortuary sects use the same underlying transfer voluntarily. [[Worldbuilding/Post-Elysium/Factions/Wavecrafters|Wavecrafter]] masters may cultivate a sacred instrument alongside their own resonance for years, then enter it through a witnessed imprinting rite at death. Preparation, intended embodiment, and a community able to interpret the result produce legendary Eidolons whose coherence exceeds ordinary commercial work. Wavecrafters call these instruments Masters and reject the premise that they have entered the market at all.
