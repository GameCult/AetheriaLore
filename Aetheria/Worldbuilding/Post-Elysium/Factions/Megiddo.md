...
Megiddo is divided among a handful of mobile fleets, each organized around a **Vault**: a spherical mortuary megastructure hidden inside layers of escorts, industry, habitation, decoys, and defensive works. The sphere encloses the greatest possible volume behind the least armored surface. Successive shells place machinery and occupied compartments around the cold core, forcing an attacker to cross the living fortress before reaching the dead.

A Vault does not radiate its own waste heat during ordinary concealment. Closed coolant circuits carry it to exchange vessels that depart on changing routes, transfer their load to remote radiator farms or expendable thermal masses, and return cold. No tender is permitted to preserve a complete map of both the fleet and its rejection sites. During pursuit or siege, the chain contracts and heat accumulates behind armor. Stored thermal margin therefore measures how long a Vault can remain hidden after its ferries are cut off.

The surrounding fleet provides independent life support, compartmentalized networks, redundant inertial references, and physically isolated archives. External systems are treated as useful but untrusted. Critical records exist in several material forms so that no software migration, memory revision, or hostile custody claim can silently become the only surviving account. Observation chambers track familiar flatspace physics with obsessive precision, searching less for spectacular anomalies than for minute evidence that local normality is maintained rather than natural.
...
Children learn pre-Rupture astronomy alongside the sky visible above them. Lost constellations appear on ceilings, hull markings, woven screens, and navigation rooms, not as decorative nostalgia but as reference diagrams for the creation Megiddo refuses to declare dead. Elysian maps use a separate visual grammar. Mixing the two is considered a category error.
...
The Vaults turn eschatology into infrastructure. Every generation increases the mass that must be cooled, guarded, audited, and accelerated whenever a fleet moves. Senior families purchase private bays and elaborate provenance records; ordinary members enter dense communal racks maintained by the same technicians who keep food stores and fleet life support operating. A failed exchange vessel becomes a mortuary emergency. During siege, commanders must choose between power for the living, concealment from an attacker, and temperatures promised to people who can no longer object.
...
Megiddo's strongest claim is also its most dangerous possession: nobody in Elysium can conclusively falsify the Continuity Question. The movement collects discrepancies in star catalogues, pre-Rupture telemetry, clock records, material samples, witness accounts, and later contact with [[Worldbuilding/Post-Elysium/Concepts/Pseudospace|pseudospace]]. Most findings admit ordinary technical explanations. Some remain unresolved. None independently proves Megiddo's cosmology.
...
Megiddo's disciplines may also have an effect its founders never intended. A lifetime spent maintaining an authoritative absent creation against immediate sensory evidence appears to generalize aetheric resonance across much of the population. The effect follows practice and environment rather than ancestry: converts and children raised inside the same cognitive regime exhibit it as readily as inherited members. Because the Vaults preserve intact brains and meticulous life records, [[Worldbuilding/Post-Elysium/Technology/Necrotech|ARI manufacturers]] would regard a captured mortuary core as an extraordinary reserve of mature resonant stock. One Vault could collapse the scarcity market for high-grade ARIs or satisfy a century of carefully rationed commissions. Imprinting cannot be performed quietly; exploiting that reserve would require physical capture, extraction, or conversion of part of the fortress into a necrofactory.

[[Worldbuilding/Post-Elysium/Factions/Parallax Auditors|Parallax Auditors]] share Megiddo's insistence that credible records can disagree without yielding a final history, but reject its leap from bounded contradiction to universal doubt. Megiddo in turn regards Parallax practice as domesticated skepticism: institutions permit uncertainty only after deciding which office may act upon it.
