...
Its habitats are built as nested sanctuaries with independent life support, compartmentalized networks, redundant inertial references, and physically isolated archives. The deepest compartments are mortuary cryovaults. External systems are treated as useful but untrusted. Critical records exist in several material forms so that no software migration, memory revision, or hostile custody claim can silently become the only surviving account. Observation chambers track familiar flatspace physics with obsessive precision, searching less for spectacular anomalies than for minute evidence that local normality is maintained rather than natural.
...
Death exposes the doctrine at its most material. Megiddo does not bury its dead in Elysium. Bodies are prepared, documented, sealed, and lowered into vast **Return Vaults**, where redundant cryogenic systems preserve them against the possibility that humanity may one day regain access to sacred ground. The dead are not patients awaiting revival. They are a population awaiting burial.

The vaults turn eschatology into infrastructure. Every generation increases the mass that must be cooled, guarded, audited, and carried through evacuation. Senior families purchase private bays and elaborate provenance records; ordinary members enter dense communal racks maintained by the same technicians who keep food stores and sanctuary life support operating. A failed compressor becomes a mortuary emergency. During siege, commanders must choose between power for the living, concealment from an attacker, and temperatures promised to people who can no longer object.

Megiddo teaches that this burden proves fidelity: the community refuses to let the Unverified Creation finish what death began. Critics within and beyond the faction see a different captivity. The living inherit maintenance obligations to an ever-growing congregation of preserved dead, while grief cannot complete itself without conceding that Elysium is somewhere a person may finally rest. Outsiders call the vaults corpse holds or freezer crypts. Megiddo records them as deferred cemeteries.
