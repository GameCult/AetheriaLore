...
### The House Voice and Three-Seal Accession

> **Authored elaboration — Charter pass, 2026-09-04.**

House Valence places its public sovereign authority in an office called the **House Voice**. The Voice may sign new Eidolon commissions, pledge future host access, carry an enclave judgment into other Valence jurisdictions, and offer transit or service guarantees in the House's name. It cannot alter the identity or operating history of a registered Eidolon by decree. Those entries belong to the Master Registrar. The Covenant Steward separately owns the accounts supporting wages, service intervals, client guarantees, and court bonds. A person may therefore lead the House without owning every record that makes the House believable.

Succession uses a **Three-Seal Accession**. The Line Seal opens the previous Voice's witnessed succession instrument and establishes which blood relative, adopted curator, or ranked alternate may claim. The Register Seal attests the claimant's identity, the instrument's custody, and any conflicts recorded against it. The Covenant Seal certifies which existing wages, host services, patron allocations, and guarantees the claimant can actually carry. Only an enclave accession court may issue a **Warrant of Voice** after all three records are presented in public session. Major clients then decide whether to recognize the warrant in their own ports, policies, and courts. Their recognition does not legally create the Voice, but a successor whom anchor clients refuse to recognize inherits a title with no market attached.

When a Voice dies, disappears, or loses capacity before accession, the Master Registrar becomes **Register Custodian** and acts jointly with the Covenant Steward. They may pay recorded wages, authorize safety work, preserve scheduled host service, and execute judgments already entered. They may not open a new auction, recognize an unregistered transfer, commission a new source acquisition, pledge future Eidolons, or rewrite the succession instrument. This keeps valuable instruments alive during an interregnum while preventing either archive or treasury from manufacturing a sovereign alone.

A rival claimant, client, or person whose named wages, service, or title have been pledged twice may file a **Lineage Exception**. The filing must identify one contested act, preserve the conflicting records in split custody, and post a reconciliation bond against the delay it may cause. The accession court can stay only the challenged authority, and every stay expires into review rather than becoming a general injunction. The bond makes redress easiest for patrons already capable of freezing the House. In several enclaves, provenance clerks and host fitters quietly maintain mutual-surety pools from voluntary slivers of overtime pay. The pools cannot decide a claim; they can sometimes keep a worker's evidence alive long enough to be heard.

First Registry Enclave is the customary accession seat because its archive vault, covenant desk, court, auction gallery, and host-service clinic share one secured chain of custody. That concentration makes succession fast when the seals agree and dangerous when they do not. A missing seal freezes new business while maintenance and payroll continue to drain the interregnum accounts. Competing warrants split client recognition, strand Eidolons from compatible service, and encourage curators to obtain a clerk's signature before a rival obtains the clerk.
