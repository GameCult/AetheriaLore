...
The pattern is visible without explaining itself. Valence Eidolons display recurring lost-star imagery, mortuary associations, resistance to local coordinates, fragments of Hebrew, and demands for burial somewhere their hosts cannot locate. Competitors infer a hidden mature source population. Buyers accept Valence's explanation of proprietary conditioning because the products work. Only Megiddo's highest priesthood and investigators able to connect the product pattern to its academic phase change understand whose dead are entering the market.
