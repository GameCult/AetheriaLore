...
Parallax auditors are the insurer-backed forensic specialists who turn continuity residue into enforceable inconvenience. They are not a grand state bureau and do not say, in public, that multiple timelines have contaminated the record. Their official work is route-integrity review, custody reconciliation, adverse-claim forensics, and anomalous ship-auth arbitration. Their practical work is deciding when a contradiction is expensive enough to become real.

They emerged because ports, insurers, salvage courts, and fleet registrars all needed someone to price the damage when timestamps, custody chains, access history, and command attestations disagreed without any ordinary fraud trail. Everyone involved preferred a dull professional euphemism to the alternative. A port can survive admitting it has a routing anomaly desk. It cannot easily survive announcing that official reality sometimes arrives with more than one path behind it.

### Jurisdiction

Parallax auditors work where movement becomes liability. Their reports can trigger docking holds, suspend coverage, contest salvage title, deny route certification, quarantine access histories, or poison command legitimacy until a reconciliation bond is paid. They do not usually own the port gate, the insurer ledger, or the fleet registry outright. They own the language those systems need before they can refuse service without sounding superstitious.
