...
DME's deepest practice is called **communing with the void**. It begins with sincere refusal of a target's continued existence, then turns that refusal inward. The practitioner cultivates a dissociative state in which the acting self is progressively excluded from their own model of reality: no heroic destroyer, no witness who survives the blast, no hand standing outside events to impose a preferred ending. In the strongest communion, the distinction between the practitioner, the target, and the absence being made becomes temporarily difficult to sustain. DME calls this **becoming unbeing**.

The [[Worldbuilding/Post-Elysium/Concepts/Aether|Aether]] does not create explosive energy from nihilism or reward theatrical aggression by itself. It responds when a practitioner has made absence into the stable frame through which they understand a materially bounded referent—a machine, command system, enclosure, route monopoly, weapons platform, or other structure—and releases ordinary heat, force, or cascading failure into it. The practitioner is not picturing a ruined version of the target. They are acting from a cognitive frame in which its continued existence has ceased to be one of the available outcomes.

The resulting violence remains coupled to what the practitioner meant to end. Heat finds paths into the target's surviving function. Fracture propagates through structures that would ordinarily isolate it. Damage recurs across repair, redundant components inherit the same failure, and continuity drift is less able to offer a nearby history in which the system remained whole. DME weapons are feared less because every detonation is larger than its competitors than because their damage can continue recognizing the target after the obvious blast has passed.

Precision depends upon understanding. A practitioner who knows only a hull silhouette can remove a hull from the future. One who understands its control, thermal, maintenance, and authority structures can make the function those systems preserve the object of unbeing. Hidden redundancy, misunderstood ownership, or an incorrect causal model may survive untouched. If the practitioner's mental boundary includes workers, settlements, dependent systems, or their own crew, the communion offers the Aether no principled reason to spare them. Slogans can help enter the state; they cannot make a vague absence precise.

DME cultivation therefore joins systems analysis to deliberate self-erasure. Operatives study maintenance diagrams, labor routines, supply contracts, repair doctrine, control paths, and the lives attached to them before learning what can safely be omitted from their own causal world. Music, performance, gallows humor, and witnessed demolition are induction and recovery practices as much as propaganda. A cell surrounds communion with call-and-response, touch, checklists, names, and brutally concrete repair work: social and material handles by which a practitioner may become someone again.
