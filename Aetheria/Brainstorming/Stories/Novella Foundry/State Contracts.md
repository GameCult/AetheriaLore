...
- **Cast Bible:** durable identity, history, embodiment, competence, desire, contradiction, dependency, authority, refusal, and exit.
- **Aggregate Actors:** incentives, information, exposure, response capacity, and evolving state for social bodies.
- **Relationship Matrix:** directional trust, affection, authority, dependency, debt, prejudice, attraction where relevant, obligation, and exit.
- **Character State Ledger:** event-by-event location, knowledge, belief, goal, action set, load, condition, stake, relationship delta, and residue.
...
- **POV Knowledge Matrix:** what each viewpoint may know, infer, misread, conceal, and reveal at each chapter.
