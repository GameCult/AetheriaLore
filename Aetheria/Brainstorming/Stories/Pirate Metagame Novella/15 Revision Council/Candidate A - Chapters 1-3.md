...
- Luce's regatta choice, exact 17-minute cutter and 9-14-minute survival margin, two suits, six-person transfer, credential workflow, and vocation mistake.
- Luce's courage, vanity, generosity, class formation, and implication in the recovery machinery.
- Pal's conditioned anticipation, refusal, extraction authority, independent counsel, continuity, wages, challenge rights, and survival authority.
- Samira's command-verbs negotiation and the articles' separation of domain authority.
- The Twelvefold's opacity, one contractual cut, two council votes, twelve individual rescue places, and refusal to let role-names become individual identity.
