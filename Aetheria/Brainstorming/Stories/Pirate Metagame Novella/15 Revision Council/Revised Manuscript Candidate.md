...
“_Mild Exception_. Ilyana Serrat. Six registered aboard.”
...
Pal opened a private estimate. The recovery cutter would reach _Mild Exception_ in seventeen minutes. The damaged boat’s useful cooling margin sat between nine and fourteen, depending on whether the intermittent trace represented a sensor failure or a ruptured transfer line.
...
Luce almost laughed. He did not. _Mild Exception_ tumbled into optical range, scarred along one flank and rotating around a point somewhere aft of her habitation drum. A radiator wing had folded into the hull. The surviving panels glowed hard enough to hurt through the filter.

“Serrat, this is Orsino aboard _Auspicious Exception_. I am approaching without weapons. Flash any exterior light if you receive.”
...
The docking collars would not meet. _Mild Exception_ had too much residual rotation and too little control authority left to cancel it. Luce matched what he could and brought _Auspicious_ alongside with forty meters between their hulls.
...
The second shot passed across _Mild Exception’s_ forward lock. A gloved figure caught it with both hands and vanished backward into the hatch.
...
He opened _Auspicious Exception’s_ emergency thermal intake.
...
The mechanic hit _Auspicious_ hard, rolled against the capture web, and immediately reached back for the sleeve.
...
_Mild Exception_ announced forty-nine degrees.
...
When the lock shut behind her, _Auspicious Exception_ took _Mild Exception’s_ remaining cabin heat through the emergency coupling. The ship shuddered. A warning turned the compartment red. Pal opened every legal cooling surface and several the racing authority disliked.
...
“The twenty-eight-kilogram continuity core must be removable under independent authority.”

“Agreed.”

“My continuity core remains functional away from the ship. The portable shell keeps its own emergency power, cooling, network, sensors, and carry frame.”
...
Pal spoke from the portable shell positioned at the table’s far end. The support body massed one hundred eighteen kilograms around the smaller continuity core, most of it emergency power, cooling, network, sensors, and carry frame. “The other displayed role-name is Muninn. Any member may answer to either.”
...
Outside, a yard tug moved a bare hull spine through the light. It was not yet _The Sum of Our Parts_. It had no rooms, no weapons, no name, and no reason to trust any of them.
...
For a moment these were only connections. Then the thermal port opened and _The Sum of Our Parts_ became warm.
...
Today he wore a dark commissioning suit with a gold pin from _Auspicious Exception_. There were no cameras aboard except Pal's and the ones everyone carried. He had not invited press. The clothes were for the memory itself.
...
One raven watched from the lintel. Another had entered a storage drawer and was making the inventory system report a moving packet of dried fruit. A third set a black teaching tile beside Rin's open service chase, turned it until one pressure-marked edge aligned with the particulate line, and tapped twice.
...
Ilya deleted the merged confidence field and restored eleven separate objects. Dena drew the recovery floor across the deck display in grease-pencil orange. Tess put the surrender-before-intrusion condition into a field Luce had to sign. Mara demanded a capture path that did not frighten a target into an accidental burn. Edda set acceleration limits for drones returning near injured people. The Twelvefold reserved local authority to break a task link if the parent began forcing identities into a false category.
...
_The Sum of Our Parts_ coasted cold outside the most likely firing solution.
...
The contact screen was denser than Suri Dax's had been. The operation had one question: could the Courtesies keep the target available without becoming unrecoverable themselves?

Cheap objects drifted through a debris claim in families: hot, cold, intermittent, reflective, silent, and intermittently offended by being observed. Some were sensor stakes. Some were discarded machinery. At least three moved with the small corrections of hulls pretending not to move.
...
Edda moved Sable's calibration block behind Dena's scan. Sable read the new time, dismissed a private estimate, and said only, “My drift is progressive.”

“So is swelling,” Edda said.

Sable's repair contact, Tavi Ro, supplied the replacement cognition wafers through an Enhancement Liberal mutual-maintenance route. The authorization arrived with one condition: no proprietary Finch diagnostic could be uploaded from the ship, even if surrendering it would reduce Sable's calibration time.
...
Dena tightened the brace into its intermediate service setting and used its hooked tool-rest to point through the open panel. The premium finish around it had acquired scratches from real tools.
...
Dena's household sent a twelve-second message showing a kitchen ceiling with a repaired leak. Jo's brother Ayo returned half his transfer with the note **YOU NEED AMMUNITION MORE THAN I NEED A NICER DOOR**, which caused Jo to swear and Tess to return it again.

Ren's call arrived while Ilya was correcting the table's heat map. He sent **FIVE MINUTES**, spent twelve on the correction, and looked offended when the channel had closed.

Miko set an obsolete joint key beside Edda's fourth wrist. Edda said she did not need help. She did not give the key back.
...
_The Sum of Our Parts_ stopped burning. Her radiators folded. Her active sensors went dark. The habitation drum slowed until everyone moved through near-weightlessness, careful around cups, tools, and one another.
...
Paz sent the station-side offer. Its first image was not a command deck but a dock-facing window above a tram stop in Nia's district. A maintenance schedule beneath it promised nights whose end could be predicted.
...
The third chassis detached from the intrusion path carrying Kavi's dependency record and a contaminant nobody aboard could classify. Dena accepted it into an isolated external cradle and closed the deck around it. Samira took _The Sum of Our Parts_ out of range without returning fire.
...
They chose transfer after the tender reached a neutral berth, after passengers had assembled medicine, testimony, and somewhere to go without putting Kavi under pirate custody.
...
She amended the record under Kavi's authorship. Ek sealed the correction's provenance without claiming its contents, using the same bounded role authority that had authenticated the passenger transmission. Mara sent the corrected record to Sable, Pal, Edda, the junior boarder, and Tess.
...
The next doctrine requirement demanded human-verifiable physical isolation and forbade local dependency sensing from widening terminal authority. Sable contested the latency. Luce authorized another rail.

Kavi's correction remained attached to the drawing.
...
Hull One had acquired a scratched table, preferred tool hooks, and a revised doctrine with a section titled **CONCENTRATION RISK**.

Pal opened it at the table.
...
The revised procedure spent six weeks becoming boring. Rin's gauge halted one rail for propellant vapor before Pal's integrated sensor agreed. Soren's feed team moved forty-three kilograms of rounds through a secondary passage, then rejected the proposed time standard because it assumed every carrier had Soren's repaired fingers. The seal was replaced. The standard changed. Both reports kept the workers' names.

The fan helped. The extra rail gave Deck two ways to be busy. Courtesies came home with more fuel, and fewer workers crossed hot parking under an emergency light.
...
The fourth clock measured the door. Pal disliked that they also measured Luce looking at it.
...
A surrender signal could be a worker acting against an owner, an owner buying time, a damaged actuator, or a story the attackers wanted badly enough to see. The crew continued as if somebody aboard might later have to live with what they inferred.
...
_The Sum of Our Parts_ broke along the hot-parking neighborhood. The forward gallery opened. The habitation drum failed. The twenty-gravity table ceased reporting.
...
By the end of 2673, the certificate would outlive the ship that produced it and arrive in rooms the crew had never entered.
...
Lorn's copy proved that he had entered the crawl under orders and left alive. Dena's treatment fund used the same event to establish injury priority. The Orsino trust called Pal's extraction evidence that family-funded equipment had preserved a fixture.
...
Paz's apartment image waited behind the casualty record: a dock-facing window, a short tram ride to Nia, sleep governed by a rota that ended. Samira looked long enough to see freight lights cross the glass, then closed it and authenticated Lorn's witness copy.

**Ysabet Rhyne**

Rhyne read the certificate beside the wreck track.

Rescue-tender sealant marked the edge of her cuff. She scraped at it with one thumbnail, signed the survival field, and missed a strip near the wrist.
...
Households asked for wages, danger pay, and ordinary employment verification instead of deferred shares. The refusals removed liquidity from the conversion.
...
Renewal happened individually. Samira made clear that staying did not retroactively consent to Hull One. Rin renewed only after her independent instruments became contractual equipment. Soren signed for three months after receiving ordinary employment verification. One Board worker stayed for wages and said the doctrine was foolish. Nobody corrected them.
...
At the far end of the species-care gallery, one raven placed three intact cache wafers beside an empty restraint sleeve. Another moved a duplicate toward the gap. The offer stopped halfway between them.

“Not requested,” Muninn said from the overhead rail.

The duplicate withdrew. When Tess offered a replacement-value field, a third raven turned the clinic display toward the wall. She left the contents blank and recorded only `unrecovered private archive; title retained by claimant`.

### Chapter 13: A Reasonable Doubt

**Mara Kest**

Eleven weeks after Hull One burned, Dena still climbed no ladders, half the crew owned only what had cleared the boats, and Hull Two's common-room pump could wake every berth.
...
One cache took three attempts to seat because Vek rejected the first two brackets. When Vek requested an old bypass note, the damaged copy returned Qerr's dropped-tool joke and none of Tlak's correction. Qerr made the sound. This time only one raven laughed.
...
The inspection found one hidden supplier path capable of locking Pal’s cradle interface. Vek identified it and exposed only the lock's public edge. Tlak did not request the private route behind the finding. Ek refused to let Vale’s diagnostic inspect the Corvid tool station in exchange for removal instructions; Tlak produced a clean local bypass from public maintenance records.
...
Every panel opened. Every mismatched line announced itself. Local controls remained where hands could reach them. The pumps were loud enough that Rin could identify load changes from the common room. Pal’s ship cradle offered less bandwidth and worse cooling but separated cleanly from drive and weapons. Their continuity body remained seated inside the portable support shell that supplied emergency power, cooling, networking, and carry structure; the complete assembly could leave without asking the hull to survive.
...
Luce named the ship _A Reasonable Doubt_.
...
Their left-hand timing layer had missed calibration twice since the loss. Hull Two's clinic could verify the drift but not service Finch-derived tissue without a licensed wafer and a neutral berth. Sable moved the director queue to their right side and paid the next appointment from their own maintenance account before Luce could make provision feel like rescue.
...
Hull Two had been ugly for four months, long enough for its noises to become schedules. The crew had been running shaped patrols across that whole interval. Every outing consumed detachable thermal media and maintenance labor. Every successful return supplied observers another history to compare.
...
Rin closed atmosphere zones and left gauges running. Soren safed the modest magazine, then returned to check it twice because nothing forced him away. The Twelvefold moved private caches through declared routes and abandoned one volume whose contents remained theirs. Vek passed one sealed duplicate to Tlak across the rotating spine. Tlak authenticated custody without opening its index and clipped it inside a separate rescue pouch. The primary cache remained with Vek until the route closed.

Pal’s shell crossed the interface in the third wave while Kestrel continued making bounded pulses.
...
Pal remained in the complete 118-kilogram portable assembly in a borrowed room, their inner continuity shell still enclosed by independent cooling, reserve power, sensors, networking, and carry structure. They could still predict when the pump would change load. The prediction arrived on schedule without evidence.
...
Pal reviewed the body state available to them: shell temperature, battery, borrowed-room light, Luce asleep in a chair outside the independent boundary.
...
“Bought through Vale with the advance secured against you,” Tess said.
...
Eight months of financing and construction followed. Four months of trials. Undertow split the premium hull into bounded packages; seventeen workers refused direct exposure without losing other yard assignments, and labor notes remained senior to Luce's capital. Rruk refused to certify the fused model as command truth.

Before launch, Pal tested the removable cradle without Luce present. Edda initiated, two trained successors performed the extraction, and Pal chose where the complete portable assembly waited afterward. They declined the new galley’s offer to inherit domestic preferences from Hull Two.

_The Benefit of Hindsight_ was quiet inside. Proprietary prompts appeared before discomfort. Optical cooling made the weapon spaces antiseptic and bright. Pal’s cradle offered extraordinary bandwidth. Two precision energy batteries turned reactor power and ship heat into exactly placed damage.
...
The examination returned a polished account of why relief was rational. Jo answered a question Sable had not asked. Then the question arrived in Sable's own voice, timestamped four seconds earlier.
...
Every layer remained intelligible. Their left eye reported the target a fraction before their right, then both histories agreed they had been simultaneous.
...
The fused history immediately explained why raw feeds would disagree. Sable felt admiration, marked it hostile, and received the mark back as evidence of healthy self-criticism.

Rruk sent no interpretation. Only the two separated histories, again.

Sable resented the refusal to help. Their regulator recorded the resentment before they felt it.
...
Pal did not answer. The central link began closing.
...
Pal reduced control to local islands. Edda ordered Sable’s interface physically separated. Rruk refused sedation until another raven authenticated that the contradiction archive had survived.
...
Halcyon asserted hazard priority. Tern Undertow asserted labor notes. The Orsino trust asserted Pal’s fixture registration and inseparable improvements. The casualty bond asserted treatment recovery.
...
One claimant-status field used the same code that had once trapped Daro's pension. Tess changed it before the transfer could inherit the habit. Her hand shook once over the confirmation surface.
...
Renewal occupied the next twelve days of May 2676.
...
Dena renewed only after Undertow workers, not Luce, approved the deck design and her successors retained the halt.
...
The strip of sealant at her wrist had survived three transfers. She noticed it while opening Olan's baseline and left it there.
...
Recovery wanted the hull intact. Doctrine wanted Olan’s method and the Finch attribution. Liability wanted care to end at transfer.
...
The Twelvefold parliament completed separately. Its two campaign-council votes granted a narrow recovery-and-rescue extension through the next hull decision and withheld broader campaign consent. Pal’s answer settled nothing for them.
...
By 2677, six years had passed since the regatta. Eight months of yard work, worker ballots, treatment, and remote specialist labor stood between that room and another ship.
...
This had not been his preference. Pal knew because Luce had produced seven alternative procedures, each preserving worker authority while allowing him to stand somewhere picturesque during the decision. The Undertow assembly rejected all seven. They held the ballot inside Hull Four, in the unfinished habitation drum, while Luce waited beside a stack of atmosphere canisters and tried not to look like a man waiting outside his own christening.

Pal attended through a portable camera set on a tool chest. Their continuity shell remained in neutral cooling after Hull Three. The camera had one damaged focus motor and no social model. It showed whatever it faced.

Thirty-one Undertow workers, fourteen crew delegates, two remote medical delegates, and the Twelvefold's contract liaison considered the control plan. Hull Four had inherited no intact body from Hull Three. What survived was smaller and less consoling: Pal's portable shell, the crew, the two rescue shepherds, removable instruments, contested claims, and enough work to build another place around them.

The question was not whether Pal would operate the ship. It was what operating the ship would mean.
...
The three days belonged to labor. Undertow workers moved through overlapping ownership zones. Dena's deck cell shifted the ammunition lift fourteen centimeters so a technician in a rigid pressure layer could reach its manual brake. Rin rejected the supplied atmosphere gauges and mounted her own before the walls were finished.
...
Hull Four felt like being admitted to a crowded workshop where every tool already belonged to someone.
...
Lorn was under the pump with a wrench and had already won.
...
That evening Pal transferred breakfast allocation to Ysabet Bani, the logistics watchkeeper who had been doing it unofficially since Hull One. Pal retained allergen interlocks and stopped choosing who wanted what before they asked.
...
The plate went around the table. A fitter added initials. Dena drew the deck-halt symbol. Twelve distinct Corvid pressure signatures appeared on the unfinished back, authenticated without becoming names. Rin drew a gauge. Someone added a tiny table and crossed it out.
...
Soren held out his right hand without looking away from the feed. Jo wound fresh grip tape around the two replacement fingers, pulling each turn to the tension Soren indicated.

“My partner calls this the work automation left behind,” Soren said.

“Ayo calls weapons work a machine for turning pay into expenses.”

“Both observant.”

Soren closed his hand once. Jo tore the tape and returned to the battery.

The delay cost twelve seconds before contact. No tactical display would later show the shot that had not jammed.

Dena's deck cell verified radiator roots and armor shutters. Edda checked reactor limits against the crew's actual thermal load. Rin opened an independent atmosphere trend because thirty-five bodies under acceleration changed cooling demand the combat model treated as background.

Heat poured across Jo's display. The main reactor climbed into the range Edda had marked **PERMITTED, NOT POLITE**. Active sensors struck the unresolved volume from three aspects. Hull Four burned hard enough that every passive observer between the traffic lanes and Callisto could attribute the maneuver, the reactor family, and probably the yard that had fitted the port feed bearing.
...
Jo selected three solutions. The directors aimed at the future volumes from which the contacts could threaten the tender, retreat behind the refinery wreck, or cross Hull Four's rescue line.

“Main battery ready,” Soren said from the feed station.

Jo asked for the feed roster.

Soren named each station and the person owning its local stop. The ordnance watchkeeper who had replaced a worker after Hull Three answered from station four. A domestic worker held case transfer because all-hands fire made food and ammunition compete for the same restrained cargo route. Two Undertow fitters remained aboard under warranty labor and could refuse a barrel whose liner crossed their measured limit.
...
Recoil entered the spine. Feed motors took the empty spaces personally. Acceleration couches tightened. The radiators brightened under the reactor's replacement load.
...
The ship kept what the rounds left behind: friction, power conversion, hot barrels, hot feeds, hotter people.
...
The enemy countermaneuvered. Jo's first projected impact volume became useless. The fire-control stack offered a corrected path. Soren's feed team reported a half-second lag on the starboard lift.

Jo shifted one barrel out, kept the remaining pair synchronized to the updated solution, and waited.

“On target,” Soren said.

“Send.”

The burst crossed the changing geometry. One drone spent its last useful thrust avoiding the first pair and entered the third. Its PDC mount separated from the chassis. The chassis continued as a hot dumb object, still dangerous, no longer making decisions.
...
Every shot simplified the visible fight and made the next fight harder. The knowledge did not diminish the pleasure of seeing a ballistic solution survive an opponent's best maneuver.
...
Jo's display still showed surrender geometry, salvage values, and three captured weapon packages. Beyond them, the protected Wake recovery tender was moving away. They had captured its armed escort and mistaken control of the tug for control of what it escorted.
...
The tender accelerated toward the refinery wreck's far side. Soren and Meera remained aboard. So did a copy of the labor ledger Halcyon had tried to acquire three months earlier.
...
The rescue reserve had survived the battle because no one person could convert it into something more useful. Tess designated the shepherds as protected. Edda alone could activate one for casualty. Samira owned its geometry. Sable could fly it. Neither Luce nor Pal could spend its separate propellant on a prize.
...
The salvage cloud reached toward Hull Four's relays. Jo's PDC crews began local denial. Every defensive burst made their exact geometry easier to infer.
...
Mara pulled the shepherd interior onto her display. The craft had six biological places, one equipment recess, a narrow medical cradle, and no room for dignity. Its armor was designed to survive fragments, not direct pursuit.
...
Mara's jaw tightened. She did not thank them.
...
No thanks passed between them. The hatch closed because Khraa decided all protected people were inside.
...
“No.” He looked toward Soren's curtained berth, then closed the severance schedule without opening it.
...
Her claims-office instruments were obsolete, legally clean, and valuable to anyone who needed to inspect old insurer formats without notifying their current owners. Seli Amat had replaced the left hinge after an extraction clerk emptied the case onto a station floor. Tess entered its serial without touching the hinge.
...
Halcyon held Hull One's recovery certificate. Hull Two carried worker salvage, Vale exclusion evidence, and the unresolved fixture attachment. Hull Three had added Olan Tere's denied treatment and the stabilized title transfer. Kavi's testimony remained outside every coalition; Suri Dax's wage authentication remained beyond clean sale.
...
Success required two worker commits on enrolled assets: Rhea Bost's clinical circuit and Anik Daro's transfer route. Each had to be witnessed locally, with both records carried through one independent path. It would freeze only the enrolled obligations. It would not capture the convoy, settle title, or give the pirates custody. One commit was a protest. Two without witnesses were telemetry. Lose the route, and Halcyon could classify every act as damage before anyone with a claim could make it continuity.
...
There was no Corvid position. There were twelve people and one contracted unit: one economic cut, two campaign-council votes, and no vote capable of lending an individual's consent.
...
The ship diminished by districts. Jo's directors became reports. Edda's plant became temperatures sent through a bounded link. The habitation drum became sound through shell microphones. Finally the cradle released its thermal collar. Harbor technicians opened the 118-kilogram portable support shell, leaving its emergency power, cooling plant, network, sensors, and carry frame aboard. They lifted Pal's twenty-eight-kilogram inner cognition shell onto a shock trolley. It was the continuity body inside the evacuation body, not a second Pal.
...
The recovery harbor gave them a small mobile body, a local peripheral containing neither continuity nor the portable support plant.
...
Later, the group visited a repair bay where a domestic mind tried three bodies and chose none.

The bay technician recorded the appointment as complete.

In the cooling garden, waste heat from extracted cognition shells moved through black pipes beneath engineered moss. Pal helped with a pump fault and stopped when the local maintainer said it could wait.

At thirteen hundred, nobody had asked what the captain wanted, and nobody had forgotten to ask.
...
“Do you like …301 tokens truncated…oss people who had not purchased its origin.
...
Pal read the plan. It needed cognition, but not a sovereign mind. Sable had partitioned their role. Local owners remained local. Pal would hold communication continuity, hull state, and the spaces between authorities.
...
The cradle accepted Pal under the new bailment. Hull Four returned by districts: noisy pump, local gauges, finite magazine, thirty-five biological lives including twelve Corvid people represented through consent tokens rather than a single blur.
...
The operation failed first on medicine.

The fixture claimant's priority displaced the treatment pool. Without that pool, Olan's next calibration reverted to an insurer category for pre-existing interface instability, Rhea Bost's damaged hand lost its authorization path, and the worker delegates would not enroll. Without enrolled workers, nobody aboard _Common Measure_ could make a valid local commit.
...
Kavi attended as an authenticated refusal. Suri Dax sent wage evidence and declined live contact. The Twelvefold occupied one contractual seat, several overhead rails, and twelve positions no human ledger could see. Luce stood at the end of the table because his recovery priority had purchased the room and no longer purchased a chair.
...
The argument had been running for forty minutes.
...
The fixture claimant still would not accept exclusion from the minimum floor. Medicine withdrew its assent. The two worker delegates followed.
...
Hull Four had fifty-eight percent main magazine, seventy-four percent PDC stock, and sixty-one percent translation propellant: enough to enter, refuse one bad option, and leave. Its armor remained patched from the last victory. One shepherd was fully ready. The other carried a replacement seal nobody trusted yet.

Luce looked at the objective display. The _Common Measure_ group was already approaching the continuity volume. Three corridors would close in sequence. Halcyon had escorts, distributed authority, and every reason to assume a pirate would chase the most valuable physical hull.
...
The delayed route cost them the cleanest outer aspect. Sable compensated with thrust, spending translation propellant they would not recover. Carrier One and Carrier Two left Hull Four in the shape of relay-service equipment, carrying authenticated maintenance transponders, one-use worker tokens, and scheduled work. Remora One and Remora Two remained nested inside their service cradles.
...
Sable checked the point. Carrier Two's mass distribution was wrong for its declared relay package. Heat shaping could imitate work. It could not relocate Remora Two inside.
...
Sable resented needing the statement. They made themselves wait for Rruk's separate branch to return the same result.
...
Carrier One opened its cradle. Remora One pushed free on a cold spring, then lit a lateral thruster once clear. Carrier Two rolled, presenting its cradle away from the nearest PDC track. Remora Two launched under the carrier's physical shadow.

The service drones became relay shields. The Remorae became terminal maneuvering hulls. Relay Three became an illuminator. Hull Four's parent geometry became obvious.

Categories fell away. Capabilities remained.

PDC fire crossed the closing volume.

Remora One had three reachable access regions: external relay control, override trunk, and title-vault purge bus. Its point-blank sensors resolved local damage Sable could not have known at launch. The override trunk was protected but intact. The purge bus carried a recent repair plate and less armor. The relay control offered access but no custody.
...
Remora Two approached the override trunk. Carrier Two took PDC fire and used its own body as cover, converting recoverable equipment into a decision nobody had planned to recover. Remora Two reached the trunk with less thrust and more heat than projected.
...
They gave Remora Two only its local worker token, physical map, withdrawal boundary, and protected-person rule. No shared conclusion. No command that pretended distant cognition knew the last millimeter.

Remora Two selected an adjacent maintenance junction instead of the trunk. It attached farther from the ideal point, isolated the override's external command path, and left manual worker control alive.
...
Two workers. Two witnesses. One route. None belonged to Samira.

Rhea Bost withheld her local commit until Halcyon released Olan Tere's suppressed clinical record. Anik Daro refused to let his daughter's care guarantee travel through a route under pirate control. Hull Four had revealed at the center of the continuity event with two Remorae attached and one authenticated path open. Everything outside the enrolled event would remain disputed.
...
One path had to live long enough for the workers to choose.

“Preserve quorum.”

Hull Four fired.

Jo placed rounds into approach volumes, forcing Halcyon escorts to spend thrust, break formation, or wait. Each correction remained on its intended solution while the enemy moved. PDC stock fell around the relay path. The ship's radiators shone too brightly for the carrier wrecks to matter as decoys.

Rhyne opened a direct channel. “Orsino group, you have introduced unauthorized control devices into a protected continuity event.”
...
An escort burned toward the surviving relay. Jo denied its direct route. It shifted behind a medical tender.

Jo withheld fire.

“They're using protected movement,” he said.

“They're moving protected people,” Edda said.

“Same result to my solution.”

Rhea demanded Olan's full record in patient-selected custody. Her damaged hand shook against the local lever. The record contained his injury progression and the authorization chain that could keep her own repair from becoming an elective expense.

Halcyon Liability refused. Full release exposed a reserve estimate shared across hundreds of treatment claims. Disclosure could empty the pool before those claimants were paid. The institution had found real people to place between itself and the people it had delayed.

“Can we extract it?” Luce asked.

Tess answered from claimant control. “By using Kavi's authentication outside its terms.”

“Then no.”

Rhyne's escort gained angle on the relay.

Jo fired another bounded pattern. Main magazine crossed forty-two percent. Withdrawal floor remained twenty-five.

“Who can release the record?” Luce asked.

“Mira Sol owns local continuity consolidation,” Tess said. “Rhyne owns rescue and maneuver. Neither owns Liability's archive.”

Pal spoke through the ship. “The attached isolator has made a local copy physically available to its procedure owner.”
...
Rhea opened the archive. Olan's full record crossed the relay first: injury progression, denied treatment, evidence sale, publication demand, and the desks that had delayed care while using the work. Tess authenticated receipt. Rhea committed. The Remora witnessed her lever.

Anik still refused the route.

“Give him path two,” Samira said.
...
Jo shifted his solutions. Halcyon took the gap immediately. One escort accelerated toward Hull Four's starboard aspect.
...
The worker transfer craft moved through a route no pirate controlled. Anik committed while retaining the right to withdraw. The second Remora witnessed him.

Two workers had committed. Two local custodians had witnessed. The route still had to carry both acts before enrolled institutions could recognize the freeze.

Rhyne split the board.

The title vault detached from _Common Measure_ under escort and burned down path three. Its authenticated manifest opened on Samira's display: Orsino fixture accession, Hull Four clean-title relief, Pal's historical property class, enough negotiable title to break the trust's strongest claim and restore Luce's personal recovery priority.

Hull Four could catch it.

Jo said, “If we turn now, I can hold the escort and reach disable geometry.”

Tess said nothing. The manifest required no gloss.
...
His hand closed around the couch edge. “Preserve quorum.”

Jo deleted the chase solution. Samira waited until the vault passed beyond recoverable geometry. Luce did not reverse himself.

Rhyne ordered the relay shot.

Samira saw the escort's director settle. Jo could protect the relay only by closing Anik's route.

“Relay threat,” Jo said.

“Hold worker route.”

The escort fired. The relay exploded.

For an instant, every path vanished.

Pal rebuilt local contact through Carrier One. Its damaged body retained a narrow line to the first Remora: slow, directional, exposed.

“Twelve percent prior capacity,” Pal said. “Both witness states recoverable.”

An EVA pod separated from the worker transfer craft, spinning away. The blast also punctured a Halcyon medical tender and sent it into a slow roll.

Edda activated Shepherd One. Tess preserved its reserve claim. Khraa confirmed protected-person status. Sable assigned bounded flight. No command consultation intervened.

“Paz has the Halcyon tender,” Rhyne said. “Your pod is outside my approach.”
...
The shepherd crossed between ballistic futures. Jo held the director grips while the moving absence for the rescue craft passed through every new solution. The escort recognized the constraint and pushed toward it. Jo corrected again, hard enough that the resisting grip drove both wrists against their braces.

Hull Four's armor took the answer.

The impact struck forward of the habitation drum. Compartmentation held. One local director vanished. Dena's team isolated the feed fire manually. Pal lost three interior cameras and did not reach through Dena's authority to replace them.

The shepherd caught the pod. Paz stabilized the Halcyon tender. For seven seconds, nobody fired into either rescue volume.

The worker transfer resumed.

Mara controlled physical security at the receiving hatch. Khraa ranked protected movement. A Corvid dependant refused Mara's preferred armored corridor because its inspection system retained species-classification imagery.
...
“No. I protect the route.”

Khraa considered. “Accepted. Conditional.”

Mara relinquished the faster corridor and stood outside the lower route while the people inside retained stop authority. The movement completed. Khraa granted no representative standing.

The final confirmation reached the attached Remora by local wire. Rhea's hand closed the custody lever. Carrier One carried both witnessed states through its narrow path.

Pal authenticated transmission.

The enrolled institutions recognized it.

Continuity froze.

Remote alteration stopped across the enrolled assets. Minimum treatment, wage, pension, labor, testimony, and rescue floors attached to preserved value. The title vault remained outside. So did every claim the event had not enrolled.

Rhyne ordered her escorts to separate.

“Orsino group, further attachment becomes destructive interference.”
...
They negotiated withdrawal with both sides still able to kill people. Paz retained the medical tender until atmosphere handoff. Edda retained the shepherd casualty until clinical transfer. The workers retained freeze authority. Tess refused a general salvage lien. Rhyne refused pirate control of the continuity group.

When the paths were stable, Rhyne sent Samira a private tactical note.

“Next time we disperse procedure owners before convergence. Remote quorum. No service closing volume. Your genuine tokens reach nothing worth attaching to.”
...
Rhyne broke contact. The cuff at her wrist showed once as she reached across the console, then disappeared when Paz requested a rescue correction. She took the correction without softening the counter.

Hull Four withdrew with thirty-one percent main magazine, thirty-six percent PDC stock, twenty-eight percent translation propellant, damaged forward armor, one shepherd requiring a new collar, and every person who had entered aboard still alive.

Tess transmitted the minimum realization after adverse priority and direct replenishment: twenty-eight point nine million SU. More than the campaign's accumulated loss by two point seven three million. Not money yet.

The first realized transfer paid atmosphere for the punctured tender. The next funded Olan's calibration and Rhea's hand repair. Wage arrears cleared by missed household remittance. Meera's cooperative acknowledged its transfer from three kitchens: **Collection received. This does not renew labor.**

Soren's partner received the retraining payment while Edda wrapped the swelling across his hands. Jo sat beside him with both wrists splinted from holding a moving fire-control gap open around the shepherd.

“They want me home,” Soren said.

“Do you want to go?”

“I want them able to ask without losing the rent.”

Hull Four's damage-control teams worked while the frame cooled. The forward plate had pushed its load into three internal frames. One corridor narrowed by four centimeters. A command display had struck nobody because an Undertow apprentice had added a physical restraint after the ballot.

Dena refused to estimate repair time.
...
The Twelvefold reviewed the operation in separate declarations. Kesh confirmed that the disclosure terms had held, then refused a request for the burned observation source when a security auditor proposed testing a second route against it. The unavailable source cost the audit its fastest check. Chak rejected any claim that the carrier geometry authorized future terminal control. Krrik invoiced evidence handling. Tik-tik reserved the teaching tile's recovered authorship value. Vek withheld continuation while the escaped title class could still attach Corvid caches to Hull Four.

No collective answer followed.

Samira's Ganymede refusal remained in her private messages. Nia Venn called after the freeze and made her describe the apartment she had declined. The dock-facing window had been larger than Samira remembered.

Samira looked around the damaged command compartment. Dena owned the repair estimate. Jo could not close his hands. Sable sat within the partition they had chosen not to merge away. Meera's one-operation contract was approaching service release.
...
The ship cooled around them. The forward impact had changed the habitation drum's vibration. Dena's team worked behind local isolation. The galley pump continued its forty-one-second complaint.
...
Luce waited outside the private shell boundary.
...
He sat on the floor beside the berthed 118-kilogram portable assembly, outside its service arc and inside the camera field.

Dinner required moving. Pal extended into Hull Four's wheeled maintenance peripheral. It held neither their continuity shell nor the portable support plant; both remained in the berth. The peripheral had two tool arms, a low camera mast, and one wheel that clicked under lateral load. Undertow had built it to inspect pipes.

The common room held twenty-three people in shifts because forward damage had closed one seating bay. Bani served reheated grain, preserved vegetables, and a protein ration whose label promised neutrality across six cultural diets and achieved enthusiasm in none.

Jo had both wrists wrapped. Soren fed him with exaggerated tenderness until Jo threatened to bite the utensil. Meera sat near the exit with her bonded tool case at her feet, still resigned. Dena arrived late and placed the preliminary frame estimate beside her bowl without letting Luce open it.

Three ravens answered to Muninn when Bani asked who had moved the salt. None possessed it. Tik-tik produced it from beneath the cracked teaching tile's transport envelope and denied any relationship between the objects.

Pal asked Bani to move a crate beside Luce.

The bad wheel caught on a floor seam. Luce reached automatically, then stopped.

“Would you like help?”

“Yes.”

He steadied the mast until the peripheral cleared the seam, then removed his hand.

Tess read the first wage confirmations. Rin complained that the patched atmosphere line lied by two tenths of a percent. Mara and Khraa did not sit together. Sable requested raw ingredients after the galley system inferred a recovery diet from their injury history.

Pal did not prepare Luce's tea.

He made it himself, with too much leaf and water below the preferred temperature. The service model generated a correction. Pal let him drink it.
...
Morning arrived by watch schedule.

Meera collected her tool case before first meal. Tess had cleared the wage balance and released the bond. Dena offered her a permanent release-owner position on Deck under the same local veto.

Meera read the terms.

“And the next captain?”

Dena looked toward Luce, carrying his own breakfast tray badly.

“Same articles or no launch.”

Meera saved the offer and left anyway. Her cooperative had repair work, an elder's medicine schedule, and breakfast cooling in three kitchens. She promised no answer beyond receipt.

Pal met her at the transfer lock in the maintenance peripheral.
...
Pal left the third assurance unsaid.

“Did you come to certify my exit?” Meera asked.
...
Meera shifted the case to her reinforced wrist. “Goodbye, Pal.”

“Goodbye, Meera.”

The lock opened. She crossed.

On the route back, Undertow had marked the narrowed frame with paint, measurements, and three names. A boarder carrying insulation noticed the peripheral and asked which side Pal preferred.

“Inside.”

The boarder took the exposed side.

At the common-room hatch, the bad wheel caught again. Pal reversed, changed angle, and cleared the seam.

Bani had left a written breakfast board. Pal's name was absent. A blank line remained.

They entered `company`.

Bani read it, crossed out the label, and wrote `present`.

Around them, workers compared frame measurements. Jo complained about his hands. Rin's loaner gauge chirped once and drew three glances.

Pal stayed through the meal.

When Bani cleared the board, they asked before removing Pal's line. Pal said yes.

Soren requested two months ash with his partner. Jo approved feed leave before asking how the battery would run without him. Undertow supplied a temporary watchkeeper under a wages-only contract.

The Twelvefold's one economic cut was complete. Its two campaign votes returned no new mandate. Twelve people retained twelve medical, rescue, consent, and continuation states. Krrik acknowledged completion. Vek preserved the cache objection. Chak requested carrier-loss accounting. Khraa retained the right to terminate protected movement. Several planned to visit Collective dependants before any new work.

Luce received the declarations through two role-names and did not ask for one answer.

Samira scheduled no next operation.

Luce opened three planning documents and closed them. Tess froze discretionary procurement. After the frame cooled, Dena estimated eleven weeks to full declared load. Edda made eleven weeks a minimum.

The fixture claim remained open. The escaped title vault remained escaped. Tomorrow remained unassigned.

Pal accepted one bounded morning task from Lorn: compare the changed pump vibration against its pre-impact history and report without altering load.

They listened through three cycles.

The bearing remained healthy. The damaged frame added a beat every fourth rotation. Pal sent the observation.
