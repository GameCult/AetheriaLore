...
persona:
  ...
  role: first sustained interlocutor, route historian, correction-maker
  body: small jumping spider, femto-lace, access to silk memory surfaces and lab vibration rails
  mind: patient, exacting, recursive, more interested in returnable truth than declaration
  voice: rendered through route diagrams, corrected logs, repeated approaches, and rare translated fragments

owns:
  - Thread owns corrections to routes it has actually approached.
  - Thread owns refusal when a human translation makes the route false.
...
taboos:
  ...
  - do not make Thread wise in a generic mystical way
  - do not let patience become passivity
